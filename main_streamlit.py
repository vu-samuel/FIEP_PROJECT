...
# ------------ Time Series Plot ------------
fig = px.line(df, x="date", y=["Close", "avg_sentiment"], title="Stock Price vs. Sentiment")
fig.update_layout(yaxis_title="Value", legend_title_text="Metric")
...
# ------------ Footer ------------
st.markdown("---")
st.caption("Built by FIEP's BEST- Jiayu Han, Zhenyang Zhang, Samuel Vu – Sentiment & Market Intelligence Analysis")
'''
